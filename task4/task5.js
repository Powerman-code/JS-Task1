...
const inventory = {
  ...
  const invokeAdd = invokeInventoryAction('Medkit', inventory.add  // Write code in this line
  );
  ...
  */
  ...
  const invokeRemove = invokeInventoryAction('Gas mask', inventory.remove  // Write code in this line
  );
